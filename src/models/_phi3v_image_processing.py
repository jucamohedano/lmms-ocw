...
class Phi3VImageProcessor(BaseImageProcessor):
    r"""Constructs a Phi3 image processor. Based on [`CLIPImageProcessor`] with incorporation of additional techniques
    ...
    def calc_num_image_tokens(self, images: ImageInput):
        ...
        num_img_tokens = [
            int((h // 336 * w // 336 + 1) * 144 + 1 + (h // 336 + 1) * 12) for h, w in shapes
        ]
    ...
    def calc_num_image_tokens_from_image_size(self, width, height):
        ...
        num_img_tokens = int(
            (new_height // 336 * new_width // 336 + 1) * 144 + 1 + (new_height // 336 + 1) * 12
        )
        return num_img_tokens
    ...
    def preprocess(
        ...
        image_transformed = [
            pad_to_max_num_crops_tensor(im, self.num_crops + 1) for im in hd_images_reshape
        ]
