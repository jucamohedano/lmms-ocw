...
def embedding_checkpoint_wrapper(
    activation_checkpointing: str | dict,
) -> Callable:
...
def attn_checkpointing(activation_checkpointing: str | dict, i) -> str | dict:
...
class MeanVarianceNormLayer(nn.Module):
    ...
    def __init__(self, input_size):
        ...
        self.global_mean: Tensor | None
        self.global_invstd: Tensor | None
    ...
    def forward(self, xs_pad, masks):
        ...
        if seq_len > max_seq_len:
            ...
            if masks is not None:
                ...
                extra_padded_subsamlped_pad_mask = extra_padded_subsamlped_pad_mask.unsqueeze(
                    -1
                ).float()
