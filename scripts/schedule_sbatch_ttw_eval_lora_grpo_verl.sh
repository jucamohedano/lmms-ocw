...
EVAL_TASKS="oxford_pets_grpo_ttw"
...
python -m accelerate.commands.launch \\
    ...
    -m eval_model \\
    --model ${model} \\
    --model_args offline_caption_dir=./offline_captions/qwen2.5-vl-7b-ttw-grpo,model_name_or_path=/leonardo_scratch/fast/EUHPC_D33_243/verl/hf_converted_checkpoints/grpo_qwen_2_5_vl_oxford_pets,ttw_finetune_method=${method},ttw_lora_backend=peft,ttw_lr=1e-4,ttw_epochs=5,ttw_concurrent_warmups=2,ttw_grad_accum=True \\
    --tasks "\${task}" \\
